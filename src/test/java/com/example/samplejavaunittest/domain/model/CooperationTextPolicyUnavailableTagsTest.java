...
public class CooperationTextPolicyUnavailableTagsTest {
	...
	@Test
	void 正常系_Bタグ開始が全角大なり() throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
	...
	@Test
	void バリデーションエラー_不完全なタグ_BRタグに半角スペースが含まれる1() throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
		CooperationTextPolicy policy = new CooperationTextPolicy();
		String target = "テスト用の文字列< br>テスト用の文字列";
		String expected = errorMessage;
		String actual = (String)unavailableTagsMethod.invoke(policy, column, target);
	...
	@Test
	void バリデーションエラー_不完全なタグ_BRタグに半角スペースが含まれる3() throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
		CooperationTextPolicy policy = new CooperationTextPolicy();
		String target = "テスト用の文字列<br >テスト用の文字列";
		String expected = errorMessage;
		String actual = (String)unavailableTagsMethod.invoke(policy, column, target);
	...
	@Test
	void バリデーションエラー_不完全なタグ_Bタグ開始に全角文字が含まれる2() throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
		CooperationTextPolicy policy = new CooperationTextPolicy();
		String target = "テスト用の文字列<b＞テスト</b>用の文字列";
		String expected = errorMessage;
		String actual = (String)unavailableTagsMethod.invoke(policy, column, target);
	...
	@Test
	void バリデーションエラー_不完全なタグ_BRタグに全角文字が含まれる1() throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
		CooperationTextPolicy policy = new CooperationTextPolicy();
		String target = "テスト用の文字列<ｂr>テスト用の文字列";
		String expected = errorMessage;
		String actual = (String)unavailableTagsMethod.invoke(policy, column, target);
		assertEquals(expected, actual);
	}
